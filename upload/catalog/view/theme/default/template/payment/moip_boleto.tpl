	...
	$.colorbox({
		...
		onClosed: function () {
			$.ajax({
				...
				cache: false,
				beforeSend: function() {
					$('#success').removeClass('hide').html('<i>Sua transação foi processada pelo <u><a href="https://www.moip.com.br/">Moip Pagamentos S/A</a></u>.<br/>Caso tenha alguma dúvida referente a transação, entre em contato com o Moip.</i>');
				},
				complete: function() {
