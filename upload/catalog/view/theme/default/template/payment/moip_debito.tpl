...
var funcaoSucesso = function(data){
	...
	$('#button-confirm').click(function(){
		$.ajax({
			...
			cache: false,
      success: function() {
        $('#success').html('<i>Sua transação foi processada pelo <u><a href="https://www.moip.com.br/">Moip Pagamentos S/A</a></u>.<br/>Caso tenha alguma dúvida referente a transação, entre em contato com o Moip.</i>').show();
      },
			complete: function() {
				setTimeout(function(){
