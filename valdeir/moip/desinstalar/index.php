<?php
	...
	if (isset($_POST) && !empty($_POST)):
		...
		if (!empty($user->rows)):
			...
			$db->query("DROP TABLE " . DB_PREFIX . "moip_nasp");
			$db->query("DROP TABLE cartaocredito");
			
			$desinstalar = "DELETE FROM " . DB_PREFIX . "extension WHERE `type` = 'payment' AND `code` = 'moip'";
			...
			if ($db->query($desinstalar)):
				...
				$mail->setSubject(html_entity_decode('MoIP Desinstalado', ENT_QUOTES, 'UTF-8'));
